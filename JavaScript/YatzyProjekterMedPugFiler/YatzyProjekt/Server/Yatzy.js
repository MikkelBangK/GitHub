...
class NewGame {
    ...
    constructor(SpillerID){
        this.SpillerID = SpillerID;
        let results = []
        for (let i = 0; i <= 5; i++) {
            results[i] = {Navn: "sameValuePoints " + i,holdStatus: false, value: sameValuePoints(i + 1)};
        }
        results[6] = {Navn: "OnePairPoints",valgt: false, value: onePairPoints()};
        results[7] = {Navn: "twoPairPoints",holdStatus: false, value: twoPairPoints()};
        results[8] = {Navn: "threeSamePoints",holdStatus: false, value: threeSamePoints()};
        results[9] = {Navn: "fourSamePoints",holdStatus: false, value: fourSamePoints()};
