...
public class IntegerHashSetTest {
    ...
    public void test_collision_strategy() {
        ...
        // Arrange
        String collisionStrategyType = "åben adressering"; // TODO: Indtast rigtigt svar på dansk (små bogstaver)
        String collisionStrategy = "liniær"; // TODO: Indtast rigtigt svar på dansk (små bogstaver)
